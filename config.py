...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7571046923:AAEh8To__rDuLPyFVDRkCVpZViJv939DEdw")
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://AnimeRavenBots:AnimeRavenBots@animeravenbots.huekk.mongodb.net/?retryWrites=true&w=majority&appName=AkaneSakuramoriFileBot")
DB_NAME = os.environ.get("DATABASE_NAME", "AkaneSakuramoriFileBot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://envs.sh/Ye.jpg https://envs.sh/Yi.jpg https://envs.sh/Y0.jpg https://envs.sh/Yb.jpg")).split() #Required
